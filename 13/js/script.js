...
/***/ "./source/js/modules/animateTitles.js":
/*!********************************************!*\
  !*** ./source/js/modules/animateTitles.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/animated-numbers.js":
/*!***********************************************!*\
  !*** ./source/js/modules/animated-numbers.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AnimatedNumbers; });
/* harmony import */ var _helpers_animate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/animate */ "./source/js/helpers/animate.js");
...
class AnimatedNumbers {
  ...
  animate() {
    ...
    this.timeout = setTimeout(() => {
      requestAnimationFrame(this.startAllAnimtions.bind(this));
    }, this.delay);
  }
  ...
  clear() {
    this.elements.forEach((number) => {
      const startNum = number.dataset.animateStart || 0;
      number.innerHTML = startNum;
    });
  }
  ...
  startAnimationForNumber(element, stopCount, duration, fps) {
    ...
    const animation = Object(_helpers_animate__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])((progress) => {
      now = Date.now();
      elapsed = now - then;
...
/* harmony import */ var _page_switch_handler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./page-switch-handler */ "./source/js/modules/page-switch-handler.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.sectionSwitcher = new _page_switch_handler__WEBPACK_IMPORTED_MODULE_1__["default"]();
  }
...
/*!***********************************!*\
  !*** ./source/js/modules/game.js ***!
  \***********************************/
/*! exports provided: TimerAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimerAnimation", function() { return TimerAnimation; });
...
/* harmony import */ var _separateTextAnim_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./separateTextAnim.js */ "./source/js/modules/separateTextAnim.js");
/* harmony import */ var _game_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./game.js */ "./source/js/modules/game.js");
/* harmony import */ var _animated_numbers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animated-numbers */ "./source/js/modules/animated-numbers.js");
...
class PageSwitchHandler {
  constructor() {
    const animationIntroTitle = new _separateTextAnim_js__WEBPACK_IMPORTED_MODULE_0__["SeparateTextAnimation"](`.intro__title`, `active`);
    const animationIntroDate = new _separateTextAnim_js__WEBPACK_IMPORTED_MODULE_0__["SeparateTextAnimation"](`.intro__date`, `active`);
    const animationHistoryTitle = new _separateTextAnim_js__WEBPACK_IMPORTED_MODULE_0__["SeparateTextAnimation"](`.slider__item-title--history`, `active`);
    const animationPrizeTitle = new _separateTextAnim_js__WEBPACK_IMPORTED_MODULE_0__["SeparateTextAnimation"](`.prizes__title`, `active`);
    const animationTimer = new _game_js__WEBPACK_IMPORTED_MODULE_1__["TimerAnimation"](`.game__counter`, 5);
    const number1 = new _animated_numbers__WEBPACK_IMPORTED_MODULE_2__["default"]({
      elements: `.prizes__item--journeys .prizes__desc b`,
      duration: 800,
      durationAttenuation: 150,
      delay: 1000
    });
    const number2 = new _animated_numbers__WEBPACK_IMPORTED_MODULE_2__["default"]({
      elements: `.prizes__item--cases .prizes__desc b`,
      duration: 800,
      durationAttenuation: 150,
      delay: 5000
    });
    const number3 = new _animated_numbers__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
/***/ "./source/js/modules/separateTextAnim.js":
/*!***********************************************!*\
  !*** ./source/js/modules/separateTextAnim.js ***!
  \***********************************************/
...
/* harmony import */ var _modules_animateTitles_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/animateTitles.js */ "./source/js/modules/animateTitles.js");
// modules
...
Object(_modules_animateTitles_js__WEBPACK_IMPORTED_MODULE_10__["default"])();
